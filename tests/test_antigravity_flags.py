...
class TestAntigravityFlags(unittest.TestCase):
    ...
    def test_global_enabled(self, mock_get_conn):
        ...
        self.assertTrue(antigravity.get_feature_flag("global_on"))
        ...
        self.assertFalse(antigravity.get_feature_flag("global_off"))
    ...
    def test_rollout_percentage(self, mock_get_conn):
        ...
        self.assertEqual(res1, res2) # Must be deterministic
    ...
    def test_targeted_users(self, mock_get_conn):
        ...
        self.assertTrue(antigravity.get_feature_flag("beta", user_id="user_vip"))
        self.assertFalse(antigravity.get_feature_flag("beta", user_id="user_normal"))
