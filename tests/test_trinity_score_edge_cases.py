...
class TestTrinityScoreEdgeCases:
    ...
    def test_partial_failure_score(self):
        ...
        # Then: 부분 점수 확인
        expected_score = (0.35 * 0.5 + 0.35 * 0.75 + 0.20 * 1.0 + 0.08 * 0.0 + 0.02 * 0.75)
...
class TestTrinityScoreRegression:
    ...
    def test_to_dict_serialization(self):
        ...
        # Then: 필수 키들 존재
        required_keys = ["truth", "goodness", "beauty", "filial_serenity", "eternity",
                        "trinity_score", "balance_status", "weights"]
