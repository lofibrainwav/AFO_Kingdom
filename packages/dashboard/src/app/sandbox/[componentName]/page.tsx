      ...
      <div className="min-h-screen bg-black flex flex-col items-center justify-center text-white p-8">
        ...
        <div className="mt-8 p-4 bg-white/5 border border-white/10 rounded-xl max-w-md">
          <p className="text-xs text-gray-500 leading-relaxed">
            Ensure the component has been generated and exported in{" "}
            <code>src/components/genui/index.ts</code>. If it was just generated, HMR might take a
            few seconds to update the registry.
          </p>
        </div>
      </div>
    );
      ...
      <div className="relative z-10 w-full max-w-6xl flex flex-col items-center">
        ...
        <div className="mt-12 opacity-30 hover:opacity-100 transition-opacity duration-500 flex flex-col items-center">
          <p className="text-[9px] font-bold text-gray-500 uppercase tracking-widest mb-1">
            Generated via Phase 9 Self-Expansion Loop
          </p>
