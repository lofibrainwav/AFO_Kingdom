        ...
        >
          ...
          <div className="relative w-12 h-12 mb-3 items-center justify-center flex">
            ...
            >
              ...
              {organ.name === "Brain" && (
                <path d="M9.5 2A2.5 2.5 0 0112 4.5v15a2.5 2.5 0 01-4.96.44 2.5 2.5 0 01-2.96-3.08 3 3 0 01-.34-5.58 2.5 2.5 0 011.32-4.24 2.5 2.5 0 01.44-5.04zM14.5 2 A2.5 2.5 0 0012 4.5v15a2.5 2.5 0 004.96.44 2.5 2.5 0 002.96-3.08 3 3 0 00.34-5.58 2.5 2.5 0 00-1.32-4.24 2.5 2.5 0 00-.44-5.04z" />
              )}
