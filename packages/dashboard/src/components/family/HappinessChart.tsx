...
const HappinessChart: React.FC<HappinessChartProps> = ({ score }) => {
  ...
  if (score >= 90) { color = 'bg-pink-500'; textColor = 'text-pink-400'; }
  else if (score >= 70) { color = 'bg-green-500'; textColor = 'text-green-400'; }
  else if (score >= 50) { color = 'bg-yellow-500'; textColor = 'text-yellow-400'; }
  else { color = 'bg-red-500'; textColor = 'text-red-400'; }
