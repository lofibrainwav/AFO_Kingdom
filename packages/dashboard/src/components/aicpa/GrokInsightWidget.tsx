...
import { Sparkles, Brain, TrendingUp, TrendingDown, Minus, RefreshCw, Zap, DollarSign } from 'lucide-react';
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-xl font-bold text-white flex items-center gap-2">
                Grok Insight
                {data?.grok_analysis.is_mock && <span className="text-xs px-2 py-0.5 bg-yellow-500/20 text-yellow-400 rounded-full border border-yellow-500/30">Mock</span>}
              </h3>
          ...
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="flex items-center justify-between p-4 bg-black/20 rounded-xl border border-white/5">
                <div className="flex items-center gap-3">
                    ...
                    {data.grok_analysis.sentiment === 'bullish' && <span className="flex items-center gap-1 text-emerald-400 font-bold"><TrendingUp className="w-4 h-4" /> Bullish</span>}
                    {data.grok_analysis.sentiment === 'bearish' && <span className="flex items-center gap-1 text-rose-400 font-bold"><TrendingDown className="w-4 h-4" /> Bearish</span>}
                    {data.grok_analysis.sentiment === 'neutral' && <span className="flex items-center gap-1 text-yellow-400 font-bold"><Minus className="w-4 h-4" /> Neutral</span>}
                </div>
            ...
            {/* Action Items */}
            <div>
                <h4 className="text-xs font-bold text-white/40 uppercase tracking-widest mb-3">Strategic Decrees</h4>
