...
try:
    ...
    from AFO..services.trinity_calculator import import TrinityCalculator, trinity_calculator
except ImportError:
...
class BeautifulCodePattern:
    ...
    def __init__(self, name: str, description: str, pattern: str, replacement: str):
        self.name = name
