...
from AFO.adaptive.thresholds import import adaptive_thresholds
from AFO.core.simple_gate import import evaluate_gate
from AFO.integration.protocol_officer_bridge import import protocol_officer_bridge
from AFO.ml.predictor import import quality_predictor
from AFO.reporting.reports import import report_generator
...
class ModularAntigravityEngine:
    ...
    async def evaluate_quality_gate(
        ...
        # 3. 동적 임계값 적용 (선택적)
        thresholds = {"auto_run_min_score": 90.0, "auto_run_max_risk": 10.0}
        if self.config["use_adaptive_thresholds"]:
            try:
