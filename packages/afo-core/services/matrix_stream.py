...
PILLAR_KEYWORDS = {
    "眞": ["type", "mypy", "strict", "TS", "safety", "validation", "integrity", "truth", "logic", "verify"],
    "善": ["risk", "vuln", "grype", "syft", "security", "guard", "ethics", "goodness", "safe", "lock"],
    "美": ["glass", "tailwind", "design", "aesthetic", "elegance", "ui", "beauty", "css", "style", "glow"],
    "孝": ["stream", "sse", "terminal", "friction", "serenity", "feedback", "zero", "peace", "comfort", "easy"],
    "永": ["log", "evolution", "ssot", "record", "persistent", "history", "eternal", "database", "memory", "save"]
}
        ...
        for pillar, keywords in PILLAR_KEYWORDS.items():
            ...
            for token in doc_tokens:
                ...
                if token in keywords:
                    matches += 1
                elif token.rstrip('s') in keywords:
                    matches += 1
