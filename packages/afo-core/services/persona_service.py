...
class PersonaService:
    ...
    async def switch_persona(self, persona_type: str, context: dict[str, Any] | None = None) -> dict[str, Any]:
        """
    ...
    async def get_current_persona(self) -> dict[str, Any]:
        ...
        return {
            ...
            "last_switched": self._current_persona.last_switched.isoformat() if self._current_persona.last_switched else None,
        }
...
# 편의 함수
async def switch_persona(persona_type: str, context: dict[str, Any] | None = None) -> dict[str, Any]:
    """페르소나 전환 편의 함수"""
