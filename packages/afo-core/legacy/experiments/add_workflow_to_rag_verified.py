...
def create_workflow_document():
    ...
    return Document(
        ...
        metadata={
            ...
            "category": "automation",
            "tags": ["n8n", "notion", "vibecodehub", "daily-report", "automation", "playwright"],
...
def add_to_rag():
    ...
    try:
        ...
        print(f"❌ 오류 발생: {e}")
        print("   Qdrant 서비스가 실행 중인지 확인하세요: docker ps | grep qdrant")
        import traceback
...
def verify_workflow_in_rag(vectorstore):
