...
from AFO.api.compat import (aicpa_router, auth_router, budget_router,
                            ...
                            decree_router, education_system_router,
                            evolution_router, external_router, finance_router,
                            ...
                            streams_router, system_health_router, tax_router,
...
class AFORouterManager:
    ...
    def _register_feature_routers(self) -> None:
        ...
        self._safe_register_router(
            rag_stream_router, prefix="/api", tags=["Brain Organ (RAG)"]
        )
    ...
    def _register_phase_routers(self) -> None:
        ...
        self._safe_register_router(
            external_router, tags=["Phase 13: External Interface"]
        )
        self._safe_register_router(
        ...
        try:
            ...
            self._safe_register_router(
                rag_router, prefix="/api", tags=["RAG Streaming"]
            )
        except ImportError:
    ...
    def _register_compatibility_routers(self) -> None:
        ...
        try:
            ...
            self._safe_register_router(
                intake_router, prefix="/api/intake", tags=["Intake"]
            )
        except ImportError:
