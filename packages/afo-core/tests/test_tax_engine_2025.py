...
def test_federal_tax_basic_calculation():
    """기본 연방 세금 계산 테스트"""
    params = _get_test_params()
    ...
    tax, taxable, deduction = calc.calculate_federal_tax_2025(tax_input)
...
def test_ca_tax_basic_calculation():
    """기본 CA 주세 계산 테스트"""
    params = _get_test_params()
    calc = TaxCalculator(params)
    ...
    tax, taxable, deduction = calc.calculate_ca_tax_2025(tax_input)
...
def test_total_tax_calculation():
    """연방 + CA 총 세금 계산 테스트"""
    params = _get_test_params()
    calc = TaxCalculator(params)
...
def test_bracket_boundary_consistency():
    ...
    for income in incomes:
        ...
        tax, _, _ = calc.calculate_federal_tax_2025(tax_input)
...
def test_senior_bonus_deduction():
    ...
    _, _, deduction_senior = calc.calculate_federal_tax_2025(tax_input_senior)
    _, _, deduction_regular = calc.calculate_federal_tax_2025(tax_input_regular)

    # 고령자 보너스 공제로 공제액이 더 커야 함
    assert deduction_senior > deduction_regular


def test_itemized_vs_standard_deduction():
