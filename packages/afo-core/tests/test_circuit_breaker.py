...
def test_circuit_breaker_initial_state(client: TestClient):
...
def test_circuit_breaker_failure_handling(client: TestClient):
...
def test_circuit_breaker_state_transitions(client: TestClient):
...
def test_circuit_breaker_recovery(client: TestClient):
