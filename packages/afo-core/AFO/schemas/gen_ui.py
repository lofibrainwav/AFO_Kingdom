...
class GenUIRequest(BaseModel):
    ...
    context: dict[str, Any] | None = Field(default_factory=dict, description="Additional context or props")
    trinity_threshold: float = Field(0.8, description="Minimum Trinity Score required for auto-approval")
