...
class SageRequest(BaseSchema):
    ...
    system_context: Optional[str] = Field(None, description="Optional override system prompt")
...
class SageResponse(BaseSchema):
    ...
    metadata: dict[str, Any] = Field(default_factory=dict, description="Execution metadata (latency, tokens)")
