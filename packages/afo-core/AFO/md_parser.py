...
def main():
    ...
    if len(sys.argv) < 2:
        print("Usage: python md_parser.py <md_file>")
        return
    ...
    try:
        ...
        print(f"Files to create: {parsed.files_to_create}")
        print(f"Files to update: {parsed.files_to_update}")
        print(f"Raw notes: {parsed.raw_notes}")
