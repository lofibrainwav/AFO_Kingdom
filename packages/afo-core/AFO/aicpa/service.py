...
from AFO.report_generator import import (
    generate_email_draft,
    generate_quickbooks_csv,
    generate_strategy_report,
    generate_turbotax_csv,
)
from AFO.tax_engine import import FilingStatus, TaxInput, calculate_tax, simulate_roth_ladder
...
class AICPAService:
    ...
    def generate_all_documents(
        ...
        # 4. Email Draft
        try:
            files["email_draft"] = generate_email_draft(client_name, tax_result)
        except Exception as e:
