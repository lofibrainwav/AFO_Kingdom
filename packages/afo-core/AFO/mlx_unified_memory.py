...
class MLXUnifiedMemoryManager:
    ...
    def __init__(self, initial_pool_size: int = 1024 * 1024):  # 1MB 기본
        """
        통합 메모리 관리자 초기화
...
class MLXMemoryOptimizer:
    ...
    def __init__(self, memory_manager: MLXUnifiedMemoryManager):
    ...
    def get_cached_weight(self, model_name: str, weight_key: str) -> mx.array | None:
        """
        캐시된 가중치 반환
