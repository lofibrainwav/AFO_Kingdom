...
class QLoRATrainerService:
    ...
    def apply_lora_adapter(
        ...
        print(f"Trainable parameters: {trainable_params:,} ({efficiency:.2f}%)")
    ...
    def run_complete_pipeline(
        ...
        print("=" * 80)
        print("AFO Kingdom QLoRA Training Pipeline")
        print("=" * 80)
    ...
    def integrate_with_dspy_mipro(self, dspy_output_path: str) -> dict[str, Any]:
        ...
        print("Integrating with DSPy MIPROv2...")
        ...
        try:
            ...
            print(f"DSPy data loaded: {len(dspy_data)} optimized samples")
