...
class FinancialTransaction(BaseModel):
    ...
    transaction_id: str = Field(..., min_length=julie_config.MIN_TX_ID_LENGTH, description="Unique ID")
    ...
    description: str = Field(..., min_length=julie_config.MIN_DESC_LENGTH, description="Transaction Details")
    status: Literal["PENDING", "CLEARED", "REJECTED"] = "PENDING"
    
    # Audit Trail (The Prince #09: Use of Spies)
    audit_hash: Optional[str] = Field(None, description="Cryptographic Checksum")
