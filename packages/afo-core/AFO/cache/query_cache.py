...
class QueryCache:
    ...
    def __init__(self, ttl: int = 300, key_prefix: str = "db:query"):
        self.ttl = ttl
...
def cache_query(ttl: int = 300, key_prefix: str = "db:query"):
    """
...
def invalidate_cache(pattern: str):
    ...
    async def _invalidate():
        if cache_manager:
            # This would require extending the cache manager with pattern deletion
            # For now, we'll skip the actual invalidation
