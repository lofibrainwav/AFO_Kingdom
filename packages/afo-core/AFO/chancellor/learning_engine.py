...
class DecisionPattern:
    ...
    def __init__(self, situation_hash: str, decision_type: str, confidence: float):
...
class ABTestExperiment:
    ...
    def record_trial(self, variant: str, success: bool, metric_value: float = 0.0):
...
class LearningEngine:
    ...
    async def record_ab_test_result(
        ...
        if experiment.should_stop_experiment():
            ...
            await self._apply_experiment_results(
                experiment_id, cast("str", best_variant)
            )
    ...
    def get_learning_insights(self) -> dict[str, Any]:
        ...
        decision_effectiveness: dict[str, Any] = defaultdict(
