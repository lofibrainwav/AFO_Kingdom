...
class LocalObsidianBridge:
    ...
    def __init__(self, vault_path: Optional[str] = None):
        ...
        if not vault_path:
            ...
            try:
                ...
                # /Users/brnestrm/AFO_Kingdom/packages/afo-core/AFO/scholars/libraries/obsidian_bridge.py
                ...
                if "AFO_Kingdom" in str(potential_vault) and potential_vault.exists():
                    ...
                    # Fallback to hardcoded known path if relative fails
                    self.vault_path = Path("/Users/brnestrm/AFO_Kingdom/docs")
            except Exception:
                self.vault_path = Path("/Users/brnestrm/AFO_Kingdom/docs")
        else:
    ...
    def write_note(self, note_path: str, content: str, metadata: Dict[str, Any] = None) -> Dict[str, Any]:
