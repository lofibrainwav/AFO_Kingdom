...
class DependencyVerifier:
    ...
    def __init__(self, project_root: Path, timeout_seconds: int = 10):
    ...
    async def _test_single_package(
        ...
        try:
            ...
            return {"name": package_name, "status": "error", "error": error_msg, "is_core": is_core}
    ...
    async def _generate_final_report(self) -> dict[str, Any]:
        ...
        return {
            "summary": {
                ...
                "success_rate": self.results["success_count"] / self.results["total_tested"]
