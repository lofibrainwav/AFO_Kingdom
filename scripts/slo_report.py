...
def load_slo_contract(config_path: str):
...
def print_report(contract, dry_run=False):
    if not contract:
        return
...
def main():
    ...
    parser.add_argument("--config", default="packages/afo-core/config/slo.yml", help="Path to SLO config")
