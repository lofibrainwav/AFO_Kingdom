...
def test_comprehensive_health_import():
    ...
    try:
        ...
        log_debug(
            ...
            {
                "router_prefix": str(comprehensive_health_router.prefix)
...
def test_intake_import():
    ...
    try:
        ...
        log_debug(
            ...
            {
                "router_prefix": str(intake_router.prefix)
...
def test_family_import():
    ...
    try:
        ...
        log_debug(
            ...
            {
                "router_prefix": str(family_router.prefix)
...
def main():
    ...
    # Family 라우터 테스트
    print("\n3. Family 라우터")
    success, router = test_family_import()
