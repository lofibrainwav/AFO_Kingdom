...
def sequential_thinking_step_1():
    """Step 1: 문제 정의"""
    # #region agent log
    log_debug(
...
def sequential_thinking_step_2():
    """Step 2: 가설 생성"""
    # #region agent log
    log_debug(
...
def sequential_thinking_step_3():
    """Step 3: 증거 수집"""
    # #region agent log
    log_debug(
...
def sequential_thinking_step_4():
    """Step 4: 가설 평가 및 결론"""
    # #region agent log
    log_debug(
    ...
    for eval_result in evaluations:
        status_icon = (
            "✅" if eval_result["status"] == "CONFIRMED" else "❌" if eval_result["status"] == "REJECTED" else "⚠️"
        )
