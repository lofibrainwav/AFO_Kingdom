...
def step1_check_server_process():
    """1단계: 서버 프로세스 확인"""
    # #region agent log
    log_debug(
...
def step3_check_critical_endpoints():
    """3단계: 핵심 엔드포인트 확인"""
    # #region agent log
    log_debug(
...
def step4_check_router_registration():
    """4단계: 라우터 등록 상태 확인"""
    # #region agent log
    log_debug(
...
def step6_check_openapi_schema():
    """6단계: OpenAPI 스키마 확인"""
    # #region agent log
    log_debug(
