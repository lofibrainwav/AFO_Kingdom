...
async def verify_chat():
    async with async_playwright() as p:
        ...
        await page.screenshot(path=".gemini/antigravity/brain/a805a42d-de23-4690-bbb3-e36fd1dfc691/verify_chat_button.png")
        ...
        await page.screenshot(path=".gemini/antigravity/brain/a805a42d-de23-4690-bbb3-e36fd1dfc691/verify_chat_modal.png")
