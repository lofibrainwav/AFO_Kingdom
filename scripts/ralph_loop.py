...
WORKSPACE_ROOT = os.environ.get(
    "WORKSPACE_ROOT", "/Users/brnestrm/AFO_Kingdom/packages/afo-core"
)
...
def save_prd_local(data):
    with open(PRD_PATH, "w") as f:
        json.dump(data, f, indent=2)


def log_agent_learning(story_id, title, learning):
...
async def run_iteration():
    ...
    if not current_story:
        print(
            "✅ Ralph Loop: All stories are currently complete. Standing by for next deployment."
        )
        return False
