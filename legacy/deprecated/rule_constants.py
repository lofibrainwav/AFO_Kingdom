...
WEIGHTS = {
    ...
    "goodness": TrinityConfig.get_weight(Pillar.GOODNESS),
    "beauty": TrinityConfig.get_weight(Pillar.BEAUTY),
    "serenity": TrinityConfig.get_weight(Pillar.SERENITY),
    "eternity": TrinityConfig.get_weight(Pillar.ETERNITY),
}
